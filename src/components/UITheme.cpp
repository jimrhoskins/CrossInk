...
#include "components/themes/lyra/LyraMinimalTheme.h"
...
void UITheme::setTheme(CrossPointSettings::UI_THEME type) {
  switch (type) {
    ...
    case CrossPointSettings::UI_THEME::DASHBOARD:
      ...
      break;
    case CrossPointSettings::UI_THEME::LYRA_MINIMAL:
      LOG_DBG("UI", "Using Lyra Minimal theme");
      currentTheme = std::make_unique<LyraMinimalTheme>();
      currentMetrics = &LyraMinimalMetrics::values;
      break;
    default:
