...
- Recent books list and home screen now hide books from dot-prefixed folders when "Show Hidden Files" is off. Books reappear when the setting is toggled back on.
